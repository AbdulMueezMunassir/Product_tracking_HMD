...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['create_order'])) {
    ...
    try {
        ...
        $insItem = $pdo->prepare("INSERT INTO order_products (order_id, product_name, promocode, sku, size, discount_percent, price, after_discount_price, image_url) VALUES (?,?,?,?,?,?,?,?,?)");
        ...
        for ($i = 0; $i < count($product_names); $i++) {
            ...
            $insItem->execute([$order_id, $product_names[$i], $promocodes[$i], $skus[$i], $sizes[$i], $disc, $price, $after, $image_url]);
        }
    ...
    <div class="card"><div class="card-body">
        <form method="POST">
            <div class="row g-3">
                ...
                <div class="col-md-4"><label class="form-label fw-bold">Shipping Charges (Rs.)</label><input type="number" step="0.01" name="shipping_charges" id="shipping" class="form-control" value="0" placeholder="0.00"></div>
            ...
            <div id="productsContainer">
                <div class="product-row row g-2 align-items-end">
                    ...
                    <div class="col-md-1"><label class="small fw-bold">Promocode</label><input name="promocode[]" class="form-control" placeholder="Promo code"></div>
