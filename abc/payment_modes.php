...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-primary-custom { background: #0284c7; color: white; border: none; padding: 10px 25px; border-radius: 30px; transition: all 0.3s; }
        .btn-primary-custom:hover { background: #0369a1; transform: translateY(-2px); }
...
<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Manage payment modes available for orders. New modes will appear in the order form dropdown.</p>
        </div>
    ...
    <div class="card mb-4">
        <div class="card-header"><i class="fas fa-plus-circle me-2"></i> Add New Payment Mode</div>
        <div class="card-body p-4">
            <form method="POST" class="row g-3">
                ...
                <div class="col-md-3 d-flex align-items-end">
                    <button type="submit" name="add_payment_mode" class="btn btn-primary w-100"><i class="fas fa-plus"></i> Add Payment Mode</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header"><i class="fas fa-list me-2"></i> Existing Payment Modes</div>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php if(count($payment_modes) > 0): ?>
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr><td colspan="5" class="text-center py-4 text-muted">No payment modes found. Add your first payment mode above.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
